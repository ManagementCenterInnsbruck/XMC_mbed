...
{
	XMC_CCU4_SLICE_SetEvent((XMC_CCU4_SLICE_t*)US_TICKER_TIMER_2, XMC_CCU4_SLICE_IRQ_ID_COMPARE_MATCH_UP);
	XMC_CCU4_SLICE_SetEvent((XMC_CCU4_SLICE_t*)US_TICKER_TIMER_3, XMC_CCU4_SLICE_IRQ_ID_COMPARE_MATCH_UP);
}
